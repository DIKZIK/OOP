    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfPoint; ++i) {
            ...
            do {
                ...
                System.out.println("Point: (" + xCoordinate[i] + "," + yCoordinate[i] + ")");
        ...
        for (int i = 0; i < (numberOfPoint - 2); ++i) {
            ...
            for (int j = 0; j < (numberOfPoint - 1); ++j) {
                ...
                for (int k = 0; k < numberOfPoint; ++k) {
                    ...
                    square = 0.5 * (((xCoordinate[i] - xCoordinate[k]) * (yCoordinate[j] - yCoordinate[k])) - ((yCoordinate[i] - yCoordinate[k]) * (xCoordinate[j] - xCoordinate[k])));
        ...
        System.out.println(String.format("%.2f", maxSquare));
    }
}